...
def zamiana_na_wave():
    ...
    just_path = 'C:/Users/chyre/Desktop/Studia/V/TM/Projekt2/potrzebne pliki/huk'
    os.chdir(just_path)

    waves = [f for f in listdir() if f.endswith('.mp4')]
    for l in waves:
        pth2 = '/' + str(l)
        os.system('ffmpeg -i ' + pth + ' ' + pth.replace('.mp4', '.wav'))
